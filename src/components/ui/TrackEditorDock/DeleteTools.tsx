...
export default function DeleteTools() {
  ...
  return (
    <div style={styles.container}>
      ...
      >
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke={deleteMode ? '#ff6b6b' : '#888'} strokeWidth="2">
      ...
      >
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke={partialDeleteMode ? '#fbbf24' : '#888'} strokeWidth="2">
