...
describe('useCarPaintStore material settings', () => {
  ...
  test('maps normalized car model meshes to paintable parts', () => {
    ...
    expect(getPartIdForMesh('Nose_Cone')).toBe('nose')
    expect(getPartIdForMesh('Nose_Camera')).toBe('cameras')
    expect(getPartIdForMesh('FrontWing_MainPlate')).toBe('frontWing')
    ...
    expect(getPartIdForMesh('WheelHubNuts_All')).toBe('brakeHardware')
    expect(getPartIdForMesh('WheelHubNuts_FL')).toBe('brakeHardware')
    expect(getPartIdForMesh('WheelPanel_FL')).toBe('wheelPanels')
    expect(getPartIdForMesh('WheelSidewalls_All')).toBe('wheelPanels')
    expect(getPartIdForMesh('WheelSidewalls_FL')).toBe('wheelPanels')
