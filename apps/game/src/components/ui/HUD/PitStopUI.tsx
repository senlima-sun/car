...
export default function PitStopUI() {
  ...
  return (
    <div className='fixed inset-0 z-[1000] flex items-center justify-center bg-black/70 backdrop-blur-sm pointer-events-auto'>
      <Surface variant='cardStrong' className='relative flex w-[480px] flex-col gap-5 p-6'>
        ...
        {!canPerformPitStop && (
          <div className='rounded-md border border-red-500/50 bg-red-950/50 px-4 py-2 text-center font-sans text-[11px] font-bold uppercase tracking-[0.32em] text-[#ff8b8b] backdrop-blur-sm'>
            Stop the car to perform pit stop
          </div>
        )}

        <div className='flex items-center justify-between rounded-md border border-white/10 bg-white/[0.03] px-4 py-2'>
            ...
            {TIRE_ORDER.map(compound => {
              ...
              return (
                <button
                  key={compound}
                  type='button'
                  className='flex flex-col items-center gap-1.5 rounded-md border bg-white/[0.03] px-2 py-3 transition-all hover:bg-white/[0.08] active:scale-[0.98]'
        ...
        <div className='rounded-md border border-white/10 bg-white/[0.03] px-4 py-3'>
          ...
          <button
            ...
            className='mt-3 w-full rounded-md border px-4 py-2 font-sans text-[11px] font-bold uppercase tracking-[0.28em] transition-all'
            style={{
        ...
        {hasSelection && (
          <div className='rounded-md border border-white/10 bg-white/[0.03] px-4 py-2'>
        ...
        <div className='flex gap-3'>
          <button
            ...
            className='flex-1 rounded-md border border-white/20 bg-white/[0.03] px-4 py-2.5 font-sans text-[12px] font-bold uppercase tracking-[0.28em] text-white/70 transition hover:bg-white/[0.08]'
          >
            Cancel
          </button>
          <button
            ...
            disabled={!canConfirm}
            className='flex-[2] rounded-md border px-4 py-2.5 font-sans text-[13px] font-bold uppercase tracking-[0.28em] transition disabled:cursor-not-allowed'
            style={{
