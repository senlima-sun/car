...
import { Camera, Cloud, Compass, Flag, Gauge, Locate, Map, Menu, Zap } from 'lucide-react'
import { useDevToolsStore, type DevPanelId } from '../../../stores/useDevToolsStore'
import { runDevAction, type DevActionId } from '../../../hooks/devActions'
...
const TOOLS: ToolEntry[] = [
  ...
  { id: 'physics-debug', label: 'Physics', icon: Zap },
  { id: 'steering-debug', label: 'Steering', icon: Compass },
  { id: 'weather', label: 'Weather', icon: Cloud },
  { id: 'track-switcher', label: 'Track', icon: Map },
  { id: 'track-limit-snapshots', label: 'Limit Snapshots', icon: Camera },
]

const ACTIONS: ActionEntry[] = [
  { id: 'start-lights', label: 'Start Lights', icon: Flag },
]
